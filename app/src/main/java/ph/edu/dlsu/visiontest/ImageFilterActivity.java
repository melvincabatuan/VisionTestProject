package ph.edu.dlsu.visiontest;
...
public final class ImageFilterActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        Point globalCenter = new Point( mRgba.cols()/2, mRgba.rows()/2);
        ...
        switch (ImageFilterActivity.viewMode) {
            ...
            case ImageFilterActivity.VIEW_MODE_CMT_TRACKER:
                ...
                if (_trackedBox != null) {
                    ...
                    //Rect roi = new Rect(_trackedBox.x, _trackedBox.y, _trackedBox.width, _trackedBox.height);
                    ...
                    Imgproc.rectangle(mRgba, _trackedBox.tl(), _trackedBox.br(), new Scalar(255, 255, 255), 5, 8, 0);
                    Imgproc.circle(mRgba, globalCenter, 5, new Scalar(255, 255, 255), -1, 8, 0);
                    Imgproc.circle(mRgba, globalCenter, mRgba.rows()/2, new Scalar(255, 255, 255), 5, 8, 0);
                }
                break;
